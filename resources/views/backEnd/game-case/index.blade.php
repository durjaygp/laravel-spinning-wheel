        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4 ">
                            <h2>Game Case List</h2>
                        </div>
                        <div class="col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="{{ route('game-case.create') }}" class="btn btn-info d-flex align-items-center">
                                <i class="ti ti-new-section text-white me-1 fs-5"></i> Add Game Case
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="zero_config"
                                    ...
                                    <tbody>
                                        @foreach ($gameCase as $row)
                                            <!-- start row -->
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td><img src="{{ asset($row->image) }}" alt="" class="img-fluid w-25">
                                                </td>
                                                <td>{{ $row->title }}</td>
                                                ...
                                                <td>
                                                    <div class="action-btn">
                                                        <a href="{{ route('game-case.edit', $row->id) }}"
                                                       ...
                                                       document.getElementById('delete-form-{{ $row->id }}').submit();"
                                                        ...
                                                        <form id="delete-form-{{ $row->id }}"
                                                            action="{{ route('game-case.destroy', $row->id) }}"
