...
@section('title', 'Update Game Case')
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="{{ route('game-case.index') }}" class="btn btn-info d-flex align-items-center">
                                <i class="ti ti-list-details text-white me-1 fs-5"></i> Game Case List
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('game-case.update', $gameCase->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="Short description" required>{{ $gameCase->description }}</textarea>
                                </div>
                            </div>
