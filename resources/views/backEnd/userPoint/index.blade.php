        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4 ">
                            <h2> User Point List</h2>
                        </div>
                        <div class="col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="{{ route('user-point.create') }}" class="btn btn-info d-flex align-items-center">
                                <i class="ti ti-new-section text-white me-1 fs-5"></i> Add User Point
                            </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action-btn">
                                                        <a href="{{ route('user-point.edit', $row->id) }}"
                                                       ...
                                                       document.getElementById('delete-form-{{ $row->id }}').submit();"
                                                        ...
                                                        <form id="delete-form-{{ $row->id }}"
                                                            action="{{ route('user-point.destroy', $row->id) }}"
